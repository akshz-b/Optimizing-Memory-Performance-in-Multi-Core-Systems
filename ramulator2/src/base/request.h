...
struct Request { 
  ...
  Addr_t vpage = -1;  // Virtual page number
  Addr_t v_addr = -1; // Virtual address
  ...
  bool is_cached = false; // Whether the request is cached or not
  ...
  Request(Addr_t addr, int type, int source_id); // added for new custom_trace impl
