...
int main(int argc, char* argv[]) {
  ...
  Ramulator::initialize_core_channel_latency();
  ...
  // Ramulator::printAccessCounts();
  // Ramulator::printTotalCacheCounts();
  

  //calculate the average latency
  Ramulator::avg_latency = (float)Ramulator::overall_latency / (float)Ramulator::overall_request;
  std::cout << "\nAverage_latency: " << Ramulator::avg_latency << "\n";
  //print replicated access counts
  // std::cout << "Replicated access counts: " << Ramulator::replicated_access_count << "\n";
  // ///print migration counts
  // std::cout << "Migration counts: " << Ramulator::migrations << "\n";
