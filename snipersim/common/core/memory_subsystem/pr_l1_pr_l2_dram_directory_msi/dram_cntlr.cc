...
// File is opened ONCE here, in append mode
static FILE *fp = fopen("dram_trace.txt", "w");
...
namespace PrL1PrL2DramDirectoryMSI
{
   ...
   DramCntlr::DramCntlr(MemoryManagerBase *memory_manager,
       ...
       : DramCntlrInterface(memory_manager, shmem_perf_model, cache_block_size), m_reads(0), m_writes(0)
   {
